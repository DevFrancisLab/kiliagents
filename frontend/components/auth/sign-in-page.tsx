...
import { Loader2, Mail, Lock, Eye, EyeOff, ArrowLeft, Bot, CheckCircle, Shield, Users, AlertCircle } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        setErrors({ submit: "Sign in process incomplete. Please try again." })
      }
    } catch (err: any) {
